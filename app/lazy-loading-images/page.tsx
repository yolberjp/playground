...
function Credits() {
    ...
    const linkedinPostUrl = "https://www.linkedin.com/posts/midudev_trucazo-de-css-para-crear-sombras-inteligentes-activity-7315734460220502016-ukHl?utm_source=share&utm_medium=member_desktop&rcm=ACoAAB_taV4Bf1m8Lt8bnbr4Vr8mDU8zSccsvSE"
...
export default async function LazyLoadingImages() {
    ...
    return (
        <Section title="Lazy-loading Images" subtitle="Lazy load images with dynamic shadow" credits={<Credits />}>
